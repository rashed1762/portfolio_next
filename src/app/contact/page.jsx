...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      sm:text-3xl
       md:text-4xl
        lg:text-4xl">rashedul1784islam@gmail.com</h1>
       ...
       md:grid-cols-1
        ...
        p-24 ">
              <div>
                ...
                <a href="" target='blank'>
                  <h1 className="flex justify-center items-center ml-8"><Image className="h-[70px] w-[70px]" src={img1} ></Image>Instagram</h1>
                </a>
              </div>

              <div>
                <a href="https://www.linkedin.com/in/rashed-islam-/">
                <h1 className="flex justify-center items-center p-4"><Image className="h-[70px] w-[70px]" src={img3} ></Image>Linkdin</h1>
                </a>
                
                <a href="https://www.facebook.com/rajon.hasan.792/about" target='blank'>
                  <h1 className="flex justify-center items-center ml-8"><Image className="h-[70px] w-[70px]" src={img2} ></Image> Facebook</h1></a>
              </div>
